...
export const Navbar = () => {
  ...
  return (
    <div className='w-full h-fit bg-indigo-900 text-lg lg:text-2xl text-white flex flex-col items-center justify-between py-4 gap-3 md:gap-6'>
      <div className='w-full flex flex-col items-center justify-center sm:flex-row sm:px-6 gap-2'>
        ...
        {user && (
          <div className='sm:ml-auto flex flex-col sm:flex-row gap-3 items-center'>
      ...
      <div className='flex flex-wrap items-center justify-center w-fit gap-2 px-2 lg:text-2xl md:gap-4 lg:gap-7'>
        <Link
          to={"/"}
